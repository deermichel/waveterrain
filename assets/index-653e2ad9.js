...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function wa(){return new Bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vs(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Ra(){return new Bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vs(),fragmentShader:`
...
`].filter(bi).join(`
`)),o=ds(o),o=Oa(o,t),o=Ba(o,t),a=ds(a),a=Oa(a,t),a=Ba(a,t),o=za(o),a=za(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(S=`#version 300 es
